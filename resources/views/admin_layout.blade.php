			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<!-- <li>
								<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Logo Image</span></a>
								<ul>
									<li><a class="submenu" href="{{URL::to('/add-logo')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Shop Name</span></a></li>
									<li><a class="submenu" href="{{URL::to('/all-logo')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All logo</span></a></li>
...
<div id="content" class="span10">
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 Eurosia IT Inc. All rights reserved.</span>
		</p>
